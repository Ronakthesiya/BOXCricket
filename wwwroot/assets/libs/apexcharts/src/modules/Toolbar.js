...
import icoPan from './../~/UserSide/~/UserSide/assets/ico-pan-hand.svg'
import icoZoom from './../~/UserSide/~/UserSide/assets/ico-zoom-in.svg'
import icoReset from './../~/UserSide/~/UserSide/assets/ico-home.svg'
import icoZoomIn from './../~/UserSide/~/UserSide/assets/ico-plus.svg'
import icoZoomOut from './../~/UserSide/~/UserSide/assets/ico-minus.svg'
import icoSelect from './../~/UserSide/~/UserSide/assets/ico-select.svg'
import icoMenu from './../~/UserSide/~/UserSide/assets/ico-menu.svg'
