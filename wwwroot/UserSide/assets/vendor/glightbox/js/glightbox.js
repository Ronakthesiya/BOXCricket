(function (global, factory) {
  ...
  function inject~/UserSide/~/UserSide/assets(url, waitFor, callback) {
    if (isNil(url)) {
      console.error('Inject ~/UserSide/~/UserSide/assets error');
      return;
    }
  ...
  function slideVideo(slide, data, index, callback) {
    ...
    inject~/UserSide/~/UserSide/assets(this.settings.plyr.css, 'Plyr');
    var url = data.href;
    var provider = data === null || data === void 0 ? void 0 : data.videoProvider;
    var customPlaceholder = false;
    slideMedia.style.maxWidth = data.width;
    inject~/UserSide/~/UserSide/assets(this.settings.plyr.js, 'Plyr', function () {
